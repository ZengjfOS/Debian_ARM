...
if(!defined (&__ARM_PCS_VFP)) {
    eval 'sub SYS_OABI_SYSCALL_BASE () { &__NR_OABI_SYSCALL_BASE;}' unless defined(&SYS_OABI_SYSCALL_BASE);
    eval 'sub SYS_SYSCALL_BASE () { &__NR_SYSCALL_BASE;}' unless defined(&SYS_SYSCALL_BASE);
