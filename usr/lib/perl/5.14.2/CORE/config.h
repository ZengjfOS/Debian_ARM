...
/* Package name      : perl5
 * Source directory  : .
 * Configuration time: Sun Feb 28 00:45:01 UTC 2016
 * Configured by     : Debian Project
 * Target system     : linux hoiby 3.16.0-4-armmp-lpae #1 smp debian 3.16.7-ckt20-1+deb8u3 (2016-01-17) armv7l gnulinux 
 */
 ...
 */
#define ARCHLIB "/usr/lib/perl/5.14"		/**/
#define ARCHLIB_EXP "/usr/lib/perl/5.14"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PRIVLIB "/usr/share/perl/5.14"		/**/
#define PRIVLIB_EXP "/usr/share/perl/5.14"		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define SITEARCH "/usr/local/lib/perl/5.14.2"		/**/
#define SITEARCH_EXP "/usr/local/lib/perl/5.14.2"		/**/
 ...
 */
#define SITELIB "/usr/local/share/perl/5.14.2"		/**/
#define SITELIB_EXP "/usr/local/share/perl/5.14.2"		/**/
#define SITELIB_STEM ""		/**/
 ...
 *	in programs that are not prepared to deal with ~ expansion at run-time.
 */
#define PERL_VENDORARCH "/usr/lib/perl5"		/**/
#define PERL_VENDORARCH_EXP "/usr/lib/perl5"		/**/
